...
namespace ATMO.mko.Logging.LogHnd.PLX
{
    ...
    public class PlxLogHnd : ILogHnd
    {
        ...
        PNDocuTerms.DocuEntities.HTMLFormater fmtHtml;

        public PlxLogHnd(IView view, PNDocuTerms.DocuEntities.IComposer pnL, MKPRG.Naming.Language lng)
        {
            this.view = view;
            ShowError = true;
            ShowStatus = true;
            ...
            fmtHtml = new PNDocuTerms.DocuEntities.HTMLFormater(pnL, lng);
        }
