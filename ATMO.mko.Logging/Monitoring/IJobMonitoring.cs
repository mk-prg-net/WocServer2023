...
namespace ATMO.mko.Logging.Monitoring
{
    ...
    public interface IJobMonitoring
    {
        ...
        /// <returns></returns>
        RCV3sV<JobState> reportProgess(long JobId, long progress, PNDocuTerms.DocuEntities.IListMember logEntry);
        ...
        /// <returns></returns>
        RCV3sV<JobState> reportProgessAbsolute(long JobId, long progress);
        ...
        /// <param name="logEntry"></param>
        /// <returns></returns>
        RCV3sV<JobState> reportProgessAbsolute(long JobId, long progress, PNDocuTerms.DocuEntities.IListMember logEntry);
        ...
        /// <returns></returns>
        RCV3sV<JobState> completeJob(long JobId, PNDocuTerms.DocuEntities.IListMember docuTerm);
