...
namespace ATMO.mko.Logging.PNDocuTerms.DocuEntities
{
    ...
    public static class ComposerSubTrees
    {
        ...
        /// <param name="UserId"></param>
        /// <returns></returns>
        public static IInstance ReturnAuthenticationUserIsNoCustomerNorAtmoEmployee(
            this IComposer pnL,
            IPropertyValue UserId = null)
            => pnL.i(TTD.StateDescription.FinStateDescr.UID,
                pnL.m(TT.Authentication.Login.UID,
                    pnL.p_NID(TTD.StateDescription.CurrentState.UID, TT.Authentication.LoginAuthenticateUser.UID),
                    pnL.KillIf(UserId == null, () => pnL.p(TT.Authentication.UserId.UID, UserId)),
                    pnL.ret(pnL.eFails(TT.Authentication.ATMO.ErrorNotCustomerNorATMOEmployee.UID))));
        ...
        public static IInstance ReturnAuthenticationUserIsNoCustomerNorAtmoEmployee(
            this IComposer pnL,
            string UserId)
            => ReturnAuthenticationUserIsNoCustomerNorAtmoEmployee(pnL, pnL.txt(UserId));
        ...
        /// <param name="UserId"></param>
        /// <returns></returns>
        public static IInstance ReturnAuthenticationNoDFCRolesAssigned(
            this IComposer pnL,
            IPropertyValue UserId = null)
            => pnL.i(TTD.StateDescription.FinStateDescr.UID,
                pnL.m(TT.Authentication.Login.UID,
                    pnL.p_NID(TTD.StateDescription.CurrentState.UID, TT.Authentication.LoginGettingRolesAssignedToUser.UID),
                    pnL.KillIf(UserId == null, () => pnL.p(TT.Authentication.UserId.UID, UserId)),
                    pnL.p_NID(TT.Authentication.ATMO.UserClass.UID, TT.Authentication.ATMO.UserClassCoWorker.UID),
                    pnL.ret(pnL.eFails(TT.Sets.EmptySet.UID))));
        ...
        /// <param name="UserId"></param>
        /// <returns></returns>
        public static IInstance ReturnAuthenticationCustomerIsNotMemberOfAnyCustomerGroup(
            this IComposer pnL,
            string UserId = null)
            => pnL.i(TTD.StateDescription.FinStateDescr.UID,
                    pnL.m(TT.Authentication.Login.UID,
                        pnL.p_NID(TTD.StateDescription.CurrentState.UID, TT.Authentication.ATMO.LoginGettingCustomerGroupAssignedToUser.UID),
                        pnL.KillIf(UserId == null, () => pnL.p(TT.Authentication.UserId.UID, UserId)),
                        pnL.p_NID(TT.Authentication.ATMO.UserClass.UID, TT.Authentication.ATMO.UserClassCustomer.UID),
                        pnL.ret(pnL.eFails(TT.Sets.EmptySet.UID))));
        ...
        /// <param name="Reason"></param>
        /// <returns></returns>
        public static IInstance ReturnAuthenticationWarningCantCreateListOfCustomerGroups(
            this IComposer pnL,
            IPropertyValue UserId = null,
            IPropertyValue Reason = null)
            => pnL.i(TTD.StateDescription.FinStateDescr.UID,
                pnL.m(TT.Authentication.Login.UID,
                    pnL.p_NID(TTD.StateDescription.CurrentState.UID, TT.Authentication.ATMO.LoginGettingCustomerGroupAssignedToUser.UID),
                    pnL.KillIf(UserId == null, () => pnL.p(TT.Authentication.UserId.UID, UserId)),
                    pnL.p_NID(TT.Authentication.ATMO.UserClass.UID, TT.Authentication.ATMO.UserClassCoWorker.UID),
                    pnL.ret(pnL.IfElse(Reason != null,
                        () => (IReturnValue)pnL.eFails(pnL.i(TTD.MetaData.Details.UID, pnL.p(TTD.MetaData.Val.UID, Reason))),
                        () => pnL.eFails()))));
