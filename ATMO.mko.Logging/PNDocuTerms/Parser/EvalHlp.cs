...
namespace ATMO.mko.Logging.PNDocuTerms.Parser
{
    public static class EvalHlp
    {
        ...
        public static IPropertyValue EvaluateName(Stack<IToken> stack, IComposer pnL, long NID_DocuTermType)
        {
            ...
            TraceHlp.ThrowArgExIfNot(token is DocuEntities.NID || StringToken.Test(token), 
            ...
            else
            {
                ...
                stack.Pop();
                Name = new DocuEntities.String(token.Value);
            }
        ...
        //    DocuEntities.DocuEntityTypes type,
        //    Stack<IToken> stack,
        //    Func<IToken, bool> restrictions,
        //    Func<DocuEntities.IComposer, DocuEntities.IDocuEntity, DocuEntities.IDocuEntity, TDocuTerm> factory,
        //    DocuEntities.IComposer pnL)
        //    where TDocuTerm : class, DocuEntities.IDocuEntity
        //{
        ...
        //            }
        //        }
        //        var p = factory(pnL, name, Value); // new DocuEntities.DocuEntity(fmt, type, name, Value);
        //        stack.Push(p);
        //    }
        //    else
        //    {
        ...
        //    Func<IToken, bool> restrictions,
        //    Func<DocuEntities.IComposer, DocuEntities.IDocuEntity, DocuEntities.IDocuEntity, TDocuTerm> factory,
        //    Func<DocuEntities.IComposer, DocuEntities.IDocuEntity, TDocuTerm> factoryForEmptyValue,
        //    DocuEntities.IComposer pnL)
        //    where TDocuTerm : DocuEntities.IDocuEntity
        //{
        //    var name = EvalHlp.EvaluateName(stack, $"{type} without name and value");
        ...
        //    Stack<IToken> stack,
        //    Func<IToken, bool> restrictions,
        //    Func<DocuEntities.IComposer, DocuEntities.IDocuEntity, TDocuTerm> factory,
        //    Func<DocuEntities.IComposer, TDocuTerm> factoryForEmptyValue)
        //    where TDocuTerm : DocuEntities.IDocuEntity
        //{
        //    if (stack.Any() && restrictions(stack.Peek()))
        //    {
        ...
        //            Value = pnL.str(tok.Value);
        //        }
        //        var p = new DocuEntities.DocuEntity(fmt, type, Name, Value);
        //        stack.Push(p);
        //    }
        //    else
        //    {
