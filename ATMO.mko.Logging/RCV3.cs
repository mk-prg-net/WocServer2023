...
namespace ATMO.mko.Logging
{
    ...
    public class RCV3 : IRCV2
    {
        ...
        /// </summary>
        public static IReadOnlyDictionary<long, DFC.Naming.INaming> NC;

        /// <summary>
        /// mko
        /// Globaler Composer
        /// </summary>
        public static PNDocuTerms.DocuEntities.Composer pnL;
        ...
        /// <summary>
        /// mko
        /// globaler HTML- Formatter
        /// </summary>
        public static HTMLFormater fmtHTML;
        ...
        {            
            ...
            fmtPN = new PNFormater(PNDocuTerms.Fn._, NC, ANC.Language.CNT);
            pnL = new PNDocuTerms.DocuEntities.Composer(fmtPN);
            fmtHTML = new HTMLFormater(pnL, NC);
        }
