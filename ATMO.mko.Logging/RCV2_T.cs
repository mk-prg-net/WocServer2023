...
namespace ATMO.mko.Logging
{
    ...
    public class RCV2<T> : IRCV2, IRCV2<T>
    {
        ...
        internal PNDocuTerms.DocuEntities.PNFormater fmt => RCV3.fmtPN;
        ...
        public PNDocuTerms.DocuEntities.IDocuEntity ToPlx()
        {
            ...
            var details = pnL.i(ANC.DocuTerms.MetaData.Details.UID,
                            pnL.KillIf(string.IsNullOrWhiteSpace(Message), () => (IInstanceMember)pnL.p(ANC.DocuTerms.MetaData.Msg.UID, Message.Replace("#", ""))),
                            pnL.KillIf(Value == null, () => (IInstanceMember)pnL.p(ANC.DocuTerms.MetaData.Val.UID, Value.ToString().Replace("#", "").Replace("'", ""))),
