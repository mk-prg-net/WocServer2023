...
namespace ATMO.mko.Logging
{
    public class RC : ATMO.mko.Logging.ILogInfo
    {
        ...
        PNDocuTerms.DocuEntities.Composer pnL => RCV3.pnL;
        PNDocuTerms.DocuEntities.PNFormater fmt => RCV3.fmtPN;
        ...
        public static RC CreateError(Exception ex, string descr = "")
        {
            ...
            {
                rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth.Name}", rc.pnL.eFails(rc.pnL.EncapsulateAsEventParameter(TraceHlp.FlattenExceptionMessagesPN(ex))));
            } else
            {
                rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth.Name}",                                        
                            rc.pnL.eFails(descr),
                            rc.pnL.eFails(rc.pnL.EncapsulateAsEventParameter(TraceHlp.FlattenExceptionMessagesPN(ex))));
            }            
        ...
        public static RC CreateError(ITraceInfo ti, string descr) 
        {
            ...
            {
                rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth}", rc.pnL.eFails(ti.ToString()));                            
            }
            else
            {
                rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth}",                                
                            rc.pnL.eFails(ti.ToString()),
                            rc.pnL.eFails(descr));
            }
        ...
        public static RC CreateError(string descr)
        {
            ...
            RC rc = new RC();
            rc._logType = EnumLogType.Error;
            rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth.Name}", rc.pnL.eFails(descr));                
            return rc;
        }
        ...
        public static RC CreateError(PNDocuTerms.DocuEntities.IDocuEntity ErrorDescriptionAsDocuEntityInstance)
        {
            ...
            RC rc = new RC();
            rc._logType = EnumLogType.Error;
            rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth.Name}", rc.pnL.eFails(rc.pnL.EncapsulateAsEventParameter(ErrorDescriptionAsDocuEntityInstance)));
            return rc;
        }
        ...
        public static RC CreateStatus(string descr)
        {
            ...
            rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth.Name}", rc.pnL.eInfo(descr));
            return rc;
        }
        ...
        public static RC CreateStatus(PNDocuTerms.DocuEntities.IDocuEntity StatusDescriptionAsDocuEntityInstance)
        {
            ...
            RC rc = new RC();
            rc._logType = EnumLogType.Status;
            rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth.Name}", rc.pnL.eInfo(rc.pnL.EncapsulateAsEventParameter(StatusDescriptionAsDocuEntityInstance)));
            return rc;
        }
        ...
        public static RC CreateMsg(PNDocuTerms.DocuEntities.IDocuEntity MsgAsDocuEntityInstance)
        {
            ...
            RC rc = new RC();
            rc._logType = EnumLogType.Message;
            rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth.Name}", rc.pnL.eInfo(rc.pnL.EncapsulateAsEventParameter(MsgAsDocuEntityInstance)));
            return rc;
        }
        ...
        public static RC CreateMsgStatusOk(string info)
        {
            ...
            RC rc = new RC();
            rc._logType = EnumLogType.Message;
            rc._msg = rc.pnL.i($"{assembly}.{cls}.{mth.Name}", rc.pnL.eSucceeded(info));
            return rc;
        }
        ...
        {            
            var msg = pnL.i((LogType == EnumLogType.Error ? "Err" : LogType == EnumLogType.Message ? "Msg" : "Sta"), 
                    ...
                    pnL.p("User", userId),
                    pnL.p("msg", pnL.EncapsulateAsPropertyValue(_msg)));
