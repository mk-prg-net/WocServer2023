...
requirejs(['Polyfills', 'QUnit', 'Editor/StringHlp', 'Editor/RPN', 'Editor/RPNHtml', 'Editor/Parser'],
    function (Polyfills, QUnit, StringHlp, RPN, RPNHtml, Parser) {
