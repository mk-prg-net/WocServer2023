...
define(["require", "exports", "react"], function (require, exports, react_1) {
    ...
    function NewWocReact(props) {
        ...
        return (react_1.default.createElement("div", { className: "wocHeader" },
            "// Es kann ein neuer Titel definiert werden. Das erzeugt eine neue wocId // Oder es wird ein vorhandener Titel ausgew\uFFFDhlt. // Die Auswahl kann explizit erfolgen, oder es wird eine Autocomplete- Vervollst\uFFFDndigung angeboten.",
