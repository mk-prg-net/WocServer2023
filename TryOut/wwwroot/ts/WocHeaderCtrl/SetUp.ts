...
export default function WocHeaderCtrlSetUp(urlTSRoot: string, stackOps: StackOps, stackElemStructs: StackElemStructs) {
    ...
    $.fn.extend({
        WocHeaderCtrl: function (options) {
            ...
            if (searchRes.length === 0) {
                ...
                $(document).ajaxComplete(function (event, jqXHR, ajaxSettings): false | void {
                ...
                }).ajaxError(function (event, jqXHR, ajaxSettings, thrownError: any): false | void {
                    alert("Error");
                });
