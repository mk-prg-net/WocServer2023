    ...
    public static partial class DocuEntityHlp
    {
        ...
        public static string Name(this IDocuEntity entity, ANC.Language lng, IReadOnlyDictionary<long, ANC.INaming> NC)
        {
            ...
            TraceHlp.ThrowArgExIfNot(entity.IsNamed(),
                RCV3.pnL.ReturnAfterFailureWithDetails(
                    "DocuEntityHlp_Name",
                    RCV3.pnL.i(TTD.Formatting.Errors.TriedToRequestANameOfAnEntityThatIsUnnamed.UID),
                    RCV3.pnL.p(TTD.Types.DocuTerms.UID, RCV3.pnL.EncapsulateAsPropertyValue(entity))));
            ...
            if (entity is IDocuEntityWithNameAsNid dtNid)
                ...
                TraceHlp.ThrowArgEx(RCV3.pnL.i(TTD.Formatting.Errors.TriedToRequestANameOfAnEntityThatLacksInterfacesForNameAccess.UID));
        ...
        public static bool AreOfSameName(this IDocuEntity entity, IDocuEntity other)
        {
            ...
            else if (entity is IDocuEntityWithNameAsNid nidAA && other is IDocuTermWithNameAsString stStr)
            {
                ...
                isOfSameName = RCV3.NC[nidAA.DocuTermNid.NamingId].CNT == stStr.DocuTermName;
            }
            else if (entity is IDocuTermWithNameAsString stStr2 && other is IDocuEntityWithNameAsNid nidBB)
            {
                // Bei DocuTermen, die mit unterschiedlichen Bennenungstechnologien implementiert sind,
                // Erfolgt der Namensvergleich auf Basis der Kulturneutralen Darstellung (CNT)
                isOfSameName = RCV3.NC[nidBB.DocuTermNid.NamingId].CNT == stStr2.DocuTermName;
            }
        ...
        public static bool HasName(this IDocuEntity entity, long nid, ANC.Language lng = DFC.Naming.Language.CNT)
        {
            ...
            {
                return dtWithStr.Equals(RCV3.NC[nid].NameIn(lng));
            }
            else
            {
                return false;
        ...
        public static string GetText(this IPropertyValue entity, ANC.Language lng = ANC.Language.CNT)
        {
            ...
            {
                //TraceHlp.ThrowArgEx(RCV3.pnL.m("GetText", RCV3.pnL.ret(RCV3.pnL.eFails(TTD.Parser.Errors.Name_NidOrStringTokenForNameExpected.UID))));                
        ...
        {
            var ret = RC<string>.Failed(null, RC.pnL.ReturnFetchNotFound(TTD.Types.DocuTerms.UID, TTD.Types.Instance.UID, instanceWithVersion.DocuTermNid));
        ...
        {
            var ret = RC<string>.Failed(null, RC.pnL.ReturnFetchNotFound(TTD.Types.DocuTerms.UID, TTD.Types.Instance.UID, RC.pnL.str(instanceWithVersion.DocuTermName)));
        ...
        {
            var ret = RC<string>.Failed(null, RC.pnL.ReturnFetchNotFound(TTD.Types.DocuTerms.UID, TTD.Types.Instance.UID, methodWithVersion.DocuTermNid));
        ...
        {
            var ret = RC<string>.Failed(null, RC.pnL.ReturnFetchNotFound(TTD.Types.DocuTerms.UID, TTD.Types.Instance.UID, RC.pnL.str(methodWithVersion.DocuTermName)));
