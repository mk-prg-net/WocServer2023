...
namespace ATMO.mko.QueryBuilder
{
    ...
    /// </summary>
    public class NotInXpr : ColXprBase, IColXpr
    {
        public NotInXpr(IColXpr v, params IColXpr[] xmps) : base(xmps.Length + 1)
        {
        ...
        {
            return new NotInXpr((IColXpr)Elements[0],  Elements.Select(r => (IColXpr)r).ToArray());
        }
    }
}
