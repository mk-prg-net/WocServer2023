...
namespace DFC3.DB.Tables
{
    ...
    /// </summary>
    public class LogDFC_FS : Table
    {
        /// <summary>
        /// Singelton
        /// </summary>
        public static LogDFC_FS _
        {
            get
            {
                if (__ == null)
        ...
        public LogDFC_FS(string Alias = null) : base("dza_admin.BOSCH106LOG_FS", Alias)
        {
            ...
            TimeGMT = new ColName(TableName, "TIME_SERVER");
