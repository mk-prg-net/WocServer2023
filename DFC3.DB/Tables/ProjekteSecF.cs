...
namespace DFC3.DB.Tables
{
    ...
    /// für die Sicherheitsmerkmale relevanten Daten eines Projektes aus der Tab Projektliste2 zu filtern
    /// Zu jedem Projekt werden die zugehörigen Sicherheitsmerkmale aufgelsitet.
    /// </summary>
    public class ProjekteSecF : Table
    {
        public ProjekteSecF(string Alias = null) : base("dza_admin.BOSCH106_Y_PROJECT_PJNR", Alias)
        {
