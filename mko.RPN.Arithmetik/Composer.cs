...
namespace mko.RPN.Arithmetik
{
    public class Composer : mko.RPN.Composer        
    {
        ...
        //public string SUMAT(string sumands)
        //{
        ...
        public string geomSeries10()
        {
            return fnames.GeometricSeries10;
        }

        public string genPair12()
        {
            return fnames.GenPair12;
        }

        public string genTriple123()
        {
            return fnames.GenTriple123;
        }
