...
namespace mko.RPN.Arithmetik
{
    public class BasicFunctionNames : IFunctionNames
    {
        ...
        /// mko, 3.3.2020
        /// </summary>
        public string GeometricSeries10 => $"{fn.NamePrefix}geomSeries";

        public string GenPair12 => $"{fn.NamePrefix}genPair12";

        public string GenTriple123 => $"{fn.NamePrefix}genTriple123";
    }
}
