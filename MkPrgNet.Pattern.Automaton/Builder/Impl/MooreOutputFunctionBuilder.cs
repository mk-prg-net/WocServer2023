...
{
    public class MooreOutputFunctionBuilder<TStateEnum> : IMooreOutputFunctionBuilder<TStateEnum>
        where TStateEnum : struct
    {
        ...
        public MooreOutputFunctionBuilder(Tuple<TStateEnum, TStateEnum, HashSet<TStateEnum>> stateDeco, HashSet<IInput> Inputs, Dictionary<int, TStateEnum> Transistions)
        {
